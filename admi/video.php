...
require 'navigation.php';
     ...
     $rates=$conexion->query("SELECT * FROM video ");
		...
		<div style="width: 60%; display: flex;flex-wrap: wrap;justify-content: space-around;">
			 <?php foreach ($gallery as $gallery ): ?>
			 	<div style="width: 19%;margin-bottom: 20px">
			 		<video controls="" style="width: 100%;" src="../fotos/<?php echo $gallery['video'] ?>" ></video>
			 		<br>
			 		<a style="padding: 10px 30px;background: red;color: white;margin: auto; " href="deletevideo.php?id=<?php echo $gallery['id'];  ?>">DELETE</a>
			 	</div>
			 <?php endforeach ?>
		</div>
	</div>
